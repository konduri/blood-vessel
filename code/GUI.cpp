...
int main(int argc, char** argv){   
    ...
    createTrackbar( "Jaw"     , "Arm", &slider5, 360, on_trackbar5 );
    ...
    { if(cv_ptr != NULL)
      ...
      bg = overlayImage(bg, displayBattery(battery_reading), Point(1054+75+6-5,15+10-5));
      ...
      { case 0:
        ...
        bg = overlayImage(bg, img.sonar[1], pointOnRadar(sonar_front[0][0],sonar_front[0][1]));
        bg = overlayImage(bg, img.sonar[1], pointOnRadar(sonar_front[1][0],sonar_front[1][1]));
        bg = overlayImage(bg, img.sonar[1], pointOnRadar(sonar_front[2][0],sonar_front[2][1]));
        bg = overlayImage(bg, img.sonar[1], pointOnRadar(sonar_front[3][0],sonar_front[3][1]));
        bg = overlayImage(bg, img.sonar[1], pointOnRadar(sonar_front[4][0],sonar_front[4][1]));
        bg = overlayImage(bg, img.sonar[1], pointOnRadar(sonar_front[5][0],sonar_front[5][1]));
        bg = overlayImage(bg, img.sonar[1], pointOnRadar(sonar_front[6][0],sonar_front[6][1]));
        bg = overlayImage(bg, img.sonar[1], pointOnRadar(sonar_front[7][0],sonar_front[7][1]));
